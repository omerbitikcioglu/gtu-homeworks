...
private:
	...
	{
	public:
		Board(char theLastMove, int howManyMoves): lastMove(theLastMove), numOfMoves(howManyMoves){ numOfBoards++; }
		Board(): lastMove('S'), numOfMoves(0){ numOfBoards++; }
	...
	private:
		...
		void intelCheck(int& sub, int tileSol, int tile, char move, char& intelMove) const;
